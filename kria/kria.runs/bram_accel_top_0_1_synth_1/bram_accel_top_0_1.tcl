...
OPTRACE "bram_accel_top_0_1_synth_1" START { ROLLUP_AUTO }
...
synth_design -top bram_accel_top_0_1 -part xck26-sfvc784-2LV-c -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix bram_accel_top_0_1_ bram_accel_top_0_1.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bram_accel_top_0_1_stub.v
 lappend ipCachedFiles bram_accel_top_0_1_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bram_accel_top_0_1_stub.vhdl
 lappend ipCachedFiles bram_accel_top_0_1_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bram_accel_top_0_1_sim_netlist.v
 lappend ipCachedFiles bram_accel_top_0_1_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bram_accel_top_0_1_sim_netlist.vhdl
 lappend ipCachedFiles bram_accel_top_0_1_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp bram_accel_top_0_1.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips bram_accel_top_0_1]
 }
...
rename_ref -prefix_all bram_accel_top_0_1_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef bram_accel_top_0_1.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "bram_accel_top_0_1_synth_1_synth_report_utilization_0" "report_utilization -file bram_accel_top_0_1_utilization_synth.rpt -pb bram_accel_top_0_1_utilization_synth.pb"
...
OPTRACE "bram_accel_top_0_1_synth_1" END { }
