...
HD_PWD='/home/binh/Documents/aes128/kria/kria.runs/bram_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_proc_sys_reset_0_0.tcl
